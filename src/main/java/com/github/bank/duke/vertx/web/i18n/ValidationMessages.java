...
public final class ValidationMessages implements MessageBundle {
    ...
    private static final ResourceBundle BUNDLE_PT_BR = ResourceBundle.getBundle("i18n/validations", LOCALE_PT_BR);
    private static final ResourceBundle BUNDLE_EN_US = ResourceBundle.getBundle("i18n/validations", LOCALE_EN_US);
