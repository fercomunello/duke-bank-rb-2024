...
public final class Messages implements MessageBundle {
    ...
    private static final ResourceBundle BUNDLE_PT_BR = getBundle("i18n/messages", LOCALE_PT_BR);
    private static final ResourceBundle BUNDLE_EN_US = getBundle("i18n/messages", LOCALE_EN_US);
