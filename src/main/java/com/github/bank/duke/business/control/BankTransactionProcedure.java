...
@Deprecated
public final class BankTransactionProcedure implements StoredFunction<BankTransactionResult> {
    ...
    public BankTransactionProcedure(final TransactionType type,
    ...
    public static Uni<BankTransactionProcedure> of(final Long accountId, final JsonObject json) {
        ...
        return new Validations(
            ...
            .eval(BankTransactionProcedure.class, () ->
                new BankTransactionProcedure(type, description, accountId, amount.longValue())
            );
    }
