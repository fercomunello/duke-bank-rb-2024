...
class RinhaBackendFastSimulation extends Simulation {
  ...
  setUp(
    validacaoTransacoesConcorrentes("d").inject(
      ...
      criterioClienteNaoEcontrado.inject(
        ...
        debitos.inject(
          rampUsersPerSec(1).to(220).during(30.seconds),
          constantUsersPerSec(220).during(30.seconds)
        ),
        creditos.inject(
          rampUsersPerSec(1).to(110).during(30.seconds),
          constantUsersPerSec(110).during(30.seconds)
        ),
        extratos.inject(
